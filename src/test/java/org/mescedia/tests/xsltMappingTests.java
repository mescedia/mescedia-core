...
public class xsltMappingTests extends CamelSpringTestSupport  {
    ...
    private static final String extensionFunctionsTestResult = "<root xmlns:D96A=\"http://www.ibm.com/dfdl/edi/un/edifact/D96A\" xmlns:srv=\"http://www.ibm.com/dfdl/edi/un/service/4.1\" xmlns:java=\"http://xsltExtensions.mescedia.org\"><!--=======================--><!--input analyser result file--><!----><!--=======================--><interface type=\"inbound\" user=\"test\">AS2-TEST</interface><message type=\"DESADV\" version=\"D96A\" content-type=\"application/edifact\"/><sender type=\"14\">MESCEDIA-INITIALIZER</sender><receiver type=\"14\">MESCEDIA-INITIALIZER</receiver></root>";
    ...
    private static final String extensionFunctionsTestListResult = "<root xmlns:D96A=\"http://www.ibm.com/dfdl/edi/un/edifact/D96A\" xmlns:srv=\"http://www.ibm.com/dfdl/edi/un/service/4.1\" xmlns:java=\"http://xsltExtensions.mescedia.org\"><message type=\"DESADV\" version=\"D96A\" content-type=\"application/edifact\"/><dbList><record><column name=\"id\">1</column><column name=\"name\">Football T-Shirt</column><column name=\"size\">L</column><column name=\"color\">000000</column><column name=\"measureUnit\">PCE</column><column name=\"stockAvailable\">122</column></record><record><column name=\"id\">2</column><column name=\"name\">Cricket T-Shirt</column><column name=\"size\">L</column><column name=\"color\">774521</column><column name=\"measureUnit\">PCE</column><column name=\"stockAvailable\">100</column></record><record><column name=\"id\">3</column><column name=\"name\">Blue Jeans</column><column name=\"size\">S</column><column name=\"color\">103681</column><column name=\"measureUnit\">PCE</column><column name=\"stockAvailable\">300</column></record><record><column name=\"id\">5</column><column name=\"name\">Football Socks</column><column name=\"size\">M</column><column name=\"color\">000281</column><column name=\"measureUnit\">PCE</column><column name=\"stockAvailable\">37</column></record></dbList></root>" ;
    ...
    @Test
    public void xsltExtensionFunctionsListTest() throws Exception {

        getMockEndpoint("mock:xsltExtensionFunctionListTestOut").expectedBodiesReceived(extensionFunctionsTestListResult);
        template.sendBody("direct:xsltExtensionFunctionListTestIn", dfdlXmlEdifactD96a);
        assertMockEndpointsSatisfied();
    }
}
